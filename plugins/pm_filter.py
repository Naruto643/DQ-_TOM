...
#                                                       user_name= '' if username is None else username,
        ...
        if settings is not None:
            ...
            btn = [[
                InlineKeyboardButton('𝐉𝐨𝐢𝐧 𝐆𝐫𝐨𝐮𝐩', url=f'https://t.me/hb_moive')
            ], [
...
#        return await query.answer("𝐂𝐥𝐨𝐬𝐞𝐝", show_alert=True) 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💰𝙴ᴀʀɴ 𝙼ᴏɴᴇʏ 𝚆ɪᴛʜ 𝙱ᴏᴛ 💸', callback_data='earn')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
#    btn.append([f"⚠️𝐂𝐥𝐨𝐬𝐞 𝐒𝐞𝐚𝐫𝐜𝐡⚠️", callback_data="close_data", False])        
    btn.insert(0, [
        ...
        InlineKeyboardButton("𝐔𝐩𝐝𝐚𝐭𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥", url="https://t.me/naruto_update_ch")
    ])
